    ...
    if sku_file is None:
        ...
        if missing:
            ...
            def highlight_rec(v):
                ...
                return ""
            st.dataframe(sku[['SKU','Score','Rank','Recommendation','Justification','Suggested Facings','Space Needed']].style
                         .applymap(highlight_rec, subset=['Recommendation']), use_container_width=True)
